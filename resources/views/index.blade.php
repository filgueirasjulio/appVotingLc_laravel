<x-app-layout>
    <div class="filters flex space-x-6">
        ...
        <div class="w-1/3">
            <select name="other_filters" id="other_filtersy" class="w-full rounded-xl border-none px-4 py-2">
   ...
   <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xs uppercase rounded-xl
            ...
            <div class="flex flex-1 px-2 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum possimus quasi reprehenderit earum incidunt. Ad reprehenderit repudiandae dolorem ducimus modi accusamus beatae perferendis? Eum eligendi nulla aliquam numquam! Nobis, tempore rerum autem accusamus perspiciatis laudantium at excepturi sint placeat nulla beatae qui aliquam quibusdam corrupti vel dolor praesentium quam dolore itaque deleniti quod in ut earum. Cum fuga ea molestias nesciunt soluta sint maxime, magnam dolorum reprehenderit autem, vel ipsa? Vitae vel quos quaerat, fugit in reiciendis alias perspiciatis esse numquam facere cum veniam beatae voluptatem eos amet vero laborum error. Dolor distinctio temporibus iure, repellendus porro molestiae deleniti quibusdam?Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat perspiciatis eius aspernatur magni, rerum quae vel doloremque est exercitationem voluptatem iste consequuntur vero delectus dolorem expedita fugit animi facere deleniti?
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div x-data="{ isOpen: false}"
                            ...
                            <button 
                                ...
                                >
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-6 py-3">Mark as Spam</a></li>
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-6 py-3">Delete Post</a></li>
                                </ul>
                            </button>
                        </div>
                    </div>
