        ...
        <div class="w-70 mr-5">
            ...
            >
                <div class="text-center px-6 py-2 pt-6">
                    ...
                    <p class="text-xs mt-4">Lets us know what you wold like and we'll take a loot over!</p>
                </div>
                ...
                <form action="#" method="POST" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                        ...
                        rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2" placeholder="Describe your idea">
                        </textarea>
                    </div>
